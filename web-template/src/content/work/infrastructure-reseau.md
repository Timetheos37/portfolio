...
Une fois l'analyse terminée et les choix de solutions définis, vient l'étape de _designer_ l'architecture du réseau. C'est une étape cruciale dans laquelle on _design_ deux représentations du réseau : le schéma *logique* et *physique*. Ces schémas appuie l'étape du déploiement et ils sont indispensable pour le bon déroulement du travail.
